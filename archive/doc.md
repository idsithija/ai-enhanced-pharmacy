...
4. [Requirement Gathering and Analysis](#4-requirement-gathering-and-analysis)
   - 4.2.1 [Requirement Gathering Techniques](#421-requirement-gathering-technique-used-for-the-project)
   - 4.2.2 [Questionnaire](#422-questionnaire)
   - 4.2.3 [Interview](#423-interview)
   - [Summary of Interview and Questionnaire](#summary-of-the-interview-and-questionnaire)
   - 4.3 [Functional and Non-Functional Requirements](#43-functional-and-non-functional-requirements)
5. [System Design](#5-system-design)
   - 5.1 [Architecture Diagram](#51-architecture-diagram)
   - 5.2 [ER Diagram](#52-er-diagram)
   - 5.3 [UML Diagrams](#53-uml-diagrams)
   - 5.4 [Wireframe Diagram](#54-wireframe-diagram)
6. [Implementation](#6-implementation)
   - 6.1 [Technology Stack](#61-technology-stack)
   - 6.2 [Design Patterns](#62-design-patterns)
   - 6.3 [Implementation of the Program](#63-implementation-of-the-program)
...
- ✅ All core modules are functional (Inventory, POS, Prescriptions, Customers)
- ✅ AI features are integrated and operational
- ✅ System is secure with proper authentication and authorization
- ✅ User interface is intuitive and responsive
- ✅ Database is properly structured and optimized
- ✅ Comprehensive documentation is completed
...
- Verification workflow (Pending → Verified → Dispensed)
...
✅ **Improved Efficiency**: Automation reduces manual work by 60-70%  
✅ **Enhanced Safety**: AI-powered drug interaction checking reduces medication errors  
✅ **Better Customer Service**: Faster processing and intelligent assistance  
✅ **Cost Savings**: Reduced wastage, optimized inventory, no licensing costs  
...
**Cost**: £5,000 - £15,000 + £150-300/month (Rs. 1.5 - 4.5 million + Rs. 45,000 - 90,000 monthly)
...
- ✅ Node.js, React, PostgreSQL have large community support
- ✅ AI libraries (Tesseract.js, Natural.js, OpenFDA API) are production-ready
- ✅ Extensive online resources and documentation available

**Development Expertise**:
- ✅ TypeScript/JavaScript knowledge applicable to both frontend and backend
- ✅ React is well-documented with extensive tutorials
- ✅ Sequelize ORM simplifies database operations
- ✅ Express.js is straightforward for RESTful API development

**Infrastructure Requirements**:
- ✅ Development requires only standard laptop/PC (8GB RAM minimum)
- ✅ PostgreSQL runs on Windows, Mac, Linux
- ✅ Cloud deployment options available (free tiers)
- ✅ No specialized hardware required

**Integration Challenges**:
- ✅ All technologies integrate well (proven stack)
- ✅ RESTful API architecture ensures loose coupling
- ⚠️ OCR accuracy on handwritten prescriptions may vary (70-85%)
- ✅ Mitigation: Human verification step for OCR results
...
**Development Costs**:
- ✅ Development tools: **$0** (VS Code, Git, PostgreSQL all free)
- ✅ Technology licenses: **$0** (all open-source)
- ✅ AI services: **$0** (Tesseract.js, Natural.js, OpenFDA free)
- ✅ Learning resources: **$0** (free online documentation)
- ⚠️ Internet costs: **~Rs. 2,000/month** (already available)
...
**User Acceptance**:
- ✅ Interviewed pharmacists expressed interest in modern, affordable system
- ✅ HTML mockups demonstrate user-friendly interface
- ✅ Similar to familiar e-commerce and banking websites
- ⚠️ Some training required for staff unfamiliar with digital systems
- ✅ Mitigation: User manual and training materials to be provided

**Workflow Integration**:
- ✅ System designed based on actual pharmacy workflows (from interviews)
- ✅ Can run parallel with existing systems during transition
- ✅ Data import tools for migrating from spreadsheets
- ✅ Gradual adoption possible (start with one module)

**Hardware Requirements**:
- ✅ Works on existing computers (Windows 7+, Mac, Linux)
- ✅ Responsive design works on tablets and phones
- ✅ No need for specialized POS hardware (can use webcam for scanning)
- Optional: Barcode scanner, receipt printer (low cost: Rs. 15,000 - 30,000)

**Internet Dependency**:
- ⚠️ Requires internet connection for cloud deployment
- ✅ Mitigation: Can be deployed on local network (intranet)
- ✅ Mobile data backup option
- ✅ Offline mode can be implemented (future enhancement)

**Maintenance**:
- ✅ Updates can be deployed remotely
- ✅ PostgreSQL requires minimal maintenance
- ✅ Cloud hosting handles server maintenance
- ⚠️ Requires basic IT support for troubleshooting
...
**Software Licensing**:
- ✅ All technologies use permissive licenses (MIT, Apache, PostgreSQL License)
- ✅ No legal restrictions on commercial use
- ✅ No patent or copyright issues

**Data Privacy and Protection**:
- ✅ System includes authentication and role-based access control
- ✅ Password encryption using bcrypt
- ✅ Can comply with Sri Lanka's data protection guidelines
- ⚠️ Must implement proper data backup and security policies
- ✅ HTTPS encryption for data in transit

**Healthcare Regulations**:
- ✅ System assists pharmacists but doesn't replace professional judgment
- ✅ Prescription verification workflow includes pharmacist approval
- ✅ Audit trail for all transactions
- ⚠️ Must comply with Sri Lanka Pharmacy Council regulations
- ✅ System designed to support compliance, not replace it

**Intellectual Property**:
- ✅ Original code owned by developer
- ✅ Can be released as open-source or proprietary
...
- ✅ Week 1-2: Setup and planning (completed)
- ✅ Week 2-3: Authentication (manageable)
- ✅ Week 3-5: Core features (adequate time)
- ✅ Week 5-6: POS system (sufficient)
- ✅ Week 6-7: AI features (realistic)
- ✅ Week 7-8: Testing and deployment (appropriate buffer)

**Risk Factors**:
- ⚠️ Learning curve for new technologies
- ✅ Mitigation: Extensive documentation available online
- ⚠️ Potential delays in complex features (AI integration)
- ✅ Mitigation: MVP approach, prioritize core features
- ⚠️ Testing may reveal bugs requiring fixes
- ✅ Mitigation: Week 7-8 buffer for testing and fixes

**Resource Availability**:
- ✅ Developer available full-time for 8 weeks
- ✅ Supervisor available for weekly consultations
- ✅ Sister (pharmacist) available for testing and feedback
- ✅ All software tools available immediately
...
|-----------------|--------|--------|
| Technical | 9/10 | ✅ Highly Feasible |
| Economic | 10/10 | ✅ Highly Feasible |
| Operational | 8/10 | ✅ Feasible |
| Legal | 9/10 | ✅ Feasible |
| Schedule | 8/10 | ✅ Feasible |
| **Overall** | **8.8/10** | **✅ PROCEED WITH PROJECT** |
...
|---------|-----------------|-------------|--------|----------|--------------------|---------|
| **R-01** | OCR accuracy on handwritten prescriptions may be low (below 70%) | High | Medium | **HIGH** | 1. Implement human verification workflow<br>2. Allow manual override and editing<br>3. Train system with more prescription samples<br>4. Use image preprocessing to enhance quality | ✅ Mitigated |
| **R-02** | Learning curve for new technologies (TypeScript, React) delays development | Medium | Medium | **MEDIUM** | 1. Complete online tutorials before coding<br>2. Start with simple features, progress to complex<br>3. Use GitHub Copilot for code assistance<br>4. Allocate buffer time in weeks 7-8 | ✅ Mitigated |
| **R-03** | Database design flaws discovered late in development | Low | High | **MEDIUM** | 1. Complete ER diagram before coding<br>2. Review with supervisor<br>3. Use Sequelize migrations for easy schema changes<br>4. Implement proper testing of data models | ✅ Mitigated |
| **R-04** | Integration issues between frontend and backend | Medium | Medium | **MEDIUM** | 1. Design clear API contract first<br>2. Use TypeScript interfaces for type safety<br>3. Test API endpoints with Postman before frontend integration<br>4. Implement proper error handling | ✅ Mitigated |
| **R-05** | OpenFDA API rate limiting or downtime | Low | Medium | **LOW** | 1. Implement caching for frequently accessed data<br>2. Store commonly used drug info in local database<br>3. Graceful degradation if API unavailable<br>4. Monitor API usage to stay within limits | ✅ Mitigated |
| **R-06** | Security vulnerabilities (SQL injection, XSS, CSRF) | Medium | High | **HIGH** | 1. Use Sequelize ORM (prevents SQL injection)<br>2. Implement input validation on client and server<br>3. Use JWT with expiration<br>4. Enable CORS properly<br>5. Sanitize user inputs | ✅ Mitigated |
| **R-07** | Data loss due to lack of backup | Low | High | **MEDIUM** | 1. Implement automated daily database backups<br>2. Use version control (Git) for code<br>3. Cloud deployment includes backup features<br>4. Test restore procedures | ✅ Mitigated |
| **R-08** | Performance issues with large datasets | Low | Medium | **LOW** | 1. Implement pagination for list views<br>2. Use database indexing on frequently queried fields<br>3. Optimize SQL queries<br>4. Implement lazy loading on frontend | ✅ Mitigated |
| **R-09** | User resistance to adopting new system | Medium | High | **MEDIUM** | 1. Create comprehensive user manual<br>2. Provide training materials<br>3. Design intuitive UI based on user feedback<br>4. Implement gradual rollout option | ✅ Planned |
| **R-10** | Deployment issues on cloud platform | Low | Medium | **LOW** | 1. Test deployment on free tier first<br>2. Use platform-specific documentation<br>3. Environment variables for configuration<br>4. Maintain local development environment as backup | ✅ Mitigated |
| **R-11** | Scope creep - adding too many features | High | Medium | **MEDIUM** | 1. Define MVP (Minimum Viable Product) clearly<br>2. Prioritize features using MoSCoW method<br>3. Defer non-essential features to future versions<br>4. Regular progress reviews with supervisor | ✅ Controlled |
| **R-12** | Time management - running behind schedule | Medium | High | **MEDIUM** | 1. Follow Gantt chart strictly<br>2. Weekly progress tracking<br>3. Buffer time in weeks 7-8<br>4. Cut non-essential features if necessary | ✅ Monitored |
| **R-13** | Internet connectivity issues affecting development | Low | Low | **LOW** | 1. Download documentation offline<br>2. Local development environment doesn't require internet<br>3. Multiple internet options (home, mobile, campus) | ✅ Acceptable |
| **R-14** | Inaccurate drug interaction data from API | Low | High | **MEDIUM** | 1. Display disclaimer that system assists, not replaces pharmacist<br>2. Encourage pharmacist verification<br>3. Use multiple data sources when possible<br>4. Keep audit log of all interaction checks | ✅ Mitigated |
| **R-15** | Browser compatibility issues | Low | Low | **LOW** | 1. Test on Chrome, Firefox, Safari, Edge<br>2. Use React (handles cross-browser compatibility)<br>3. Use Material-UI (tested across browsers)<br>4. Avoid browser-specific features | ✅ Managed |
...
**Technical Strengths:**
- ✅ **Modern Technology Stack**: TypeScript, React, Node.js, PostgreSQL - industry-standard technologies with strong community support
- ✅ **AI Integration**: Free OCR (Tesseract.js), NLP (Natural.js), Drug Info (OpenFDA), ML (TensorFlow.js) - unique competitive advantage
- ✅ **Zero Licensing Costs**: All open-source technologies, making the solution accessible to any pharmacy
- ✅ **Full-Stack Type Safety**: TypeScript on both frontend and backend reduces bugs and improves maintainability
- ✅ **Scalable Architecture**: RESTful API design allows horizontal scaling and future expansion
- ✅ **Cross-Platform**: Web-based solution works on Windows, Mac, Linux, tablets, and phones

**Business Strengths:**
- ✅ **Real Problem Validation**: Based on actual pharmacy interviews and pain points identified by practicing pharmacists
- ✅ **Cost Advantage**: 95-98% cheaper than commercial alternatives (Rs. 0-200k vs Rs. 1.5-9 million)
- ✅ **Complete Solution**: Covers all pharmacy operations (inventory, POS, prescriptions, customers, reports)
- ✅ **User-Centric Design**: 15 UI mockups created based on user feedback and established design patterns
- ✅ **Fast ROI**: Pharmacies can recover costs in 2-3 months through efficiency gains and reduced wastage

**Development Strengths:**
- ✅ **Clear Documentation**: Comprehensive API and system documentation
- ✅ **Structured Approach**: Well-defined 8-week timeline with milestones
- ✅ **Reusable Components**: Modular design allows code reuse and easier maintenance
- ✅ **Version Controlled**: Git-based development with proper branching strategy

#### **WEAKNESSES**

**Technical Weaknesses:**
- ⚠️ **OCR Accuracy Limitations**: Handwritten prescription OCR may achieve only 70-85% accuracy vs 95%+ for commercial solutions
- ⚠️ **Single Developer**: No redundancy if developer becomes unavailable
- ⚠️ **Limited Testing**: 8-week timeline limits comprehensive testing across all scenarios
- ⚠️ **First Version Limitations**: As v1.0, may lack some advanced features of mature commercial systems
- ⚠️ **Internet Dependency**: Cloud deployment requires stable internet (can be mitigated with local deployment)

**Development Weaknesses:**
- ⚠️ **Learning Curve**: First time implementing some technologies may slow initial development
- ⚠️ **Limited Resources**: Academic project constraints (time, no budget for paid services)
- ⚠️ **No Dedicated QA**: Developer must handle both development and testing

**Business Weaknesses:**
- ⚠️ **No Brand Recognition**: New system vs established commercial products
- ⚠️ **Support Structure**: No 24/7 commercial support like enterprise systems
- ⚠️ **Limited Marketing**: Academic project has no marketing budget

#### **OPPORTUNITIES**

**Market Opportunities:**
- 📈 **Large Underserved Market**: 95% of Sri Lankan pharmacies cannot afford Rs. 1.5-9 million systems
- 📈 **Growing Healthcare Sector**: Sri Lanka's pharmacy industry expanding 8-10% annually
- 📈 **Digital Transformation**: COVID-19 accelerated adoption of digital healthcare solutions
- 📈 **FOSS Movement**: Growing acceptance of open-source software in business
- 📈 **Regional Expansion**: Similar market needs in India, Bangladesh, Pakistan, African countries

**Technical Opportunities:**
- 📈 **Mobile App Development**: React Native can reuse 70-80% of code for native mobile apps
- 📈 **API Expansion**: Can integrate with e-consultation platforms, health insurance, delivery services
- 📈 **AI Improvements**: ML models improve over time with more training data
- 📈 **Cloud Services**: Can leverage free tiers from AWS, Google Cloud, Azure for enhanced features
- 📈 **Blockchain**: Integration with medical records blockchain for prescription verification

**Business Opportunities:**
- 📈 **SaaS Model**: Can be offered as subscription service (Rs. 5,000-15,000/month)
- 📈 **Customization Services**: Offer paid customization for specific pharmacy needs
- 📈 **Training Programs**: Paid training for pharmacy staff
- 📈 **Support Contracts**: Optional paid support packages
- 📈 **White-Label Licensing**: License to pharmacy chains with branding
- 📈 **Government Partnerships**: Potential partnership with Health Ministry for nationwide rollout

**Community Opportunities:**
- 📈 **Open-Source Community**: Can attract contributors to enhance features
- 📈 **Academic Recognition**: Can be published as research paper
- 📈 **Student Projects**: Can be base for other students' enhancements

#### **THREATS**

**Competitive Threats:**
- ⚠️ **Established Competitors**: PharmacyPlus, ChemistPro have existing customer base and brand trust
- ⚠️ **Price Drop by Competitors**: Commercial vendors may reduce prices to compete
- ⚠️ **Feature Parity**: Competitors may add AI features
- ⚠️ **Free Alternatives**: Other open-source projects may emerge

**Technical Threats:**
- ⚠️ **Technology Changes**: Rapid evolution of web technologies may make stack outdated
- ⚠️ **API Dependency**: OpenFDA API changes or discontinuation would impact features
- ⚠️ **Security Vulnerabilities**: New vulnerabilities in dependencies require constant updates
- ⚠️ **Browser Compatibility**: Future browser changes may break features

**Regulatory Threats:**
- ⚠️ **Data Protection Laws**: Stricter privacy regulations may require significant modifications
- ⚠️ **Healthcare Regulations**: Changes in pharmacy regulations may require system updates
- ⚠️ **Software Licensing Laws**: Changes in open-source licensing could affect usage

**Market Threats:**
- ⚠️ **Economic Downturn**: Pharmacies may defer technology investments
- ⚠️ **Resistance to Change**: Traditional pharmacies may resist digital transformation
- ⚠️ **Infrastructure Limitations**: Poor internet in rural areas limits adoption
...
**Positive Factors:**
- ✅ **Government Digital Push**: Sri Lanka government promoting digital transformation in healthcare (e-Health Strategy 2020-2025)
- ✅ **Healthcare Priority**: Government focus on improving healthcare accessibility and quality
- ✅ **SME Support**: Policies supporting small and medium enterprises in adopting technology
- ✅ **No Import Restrictions**: Software development and deployment not subject to import duties

**Negative Factors:**
- ⚠️ **Political Instability**: Frequent government changes may affect healthcare policies
- ⚠️ **Bureaucratic Processes**: Slow approval processes if government partnership sought
- ⚠️ **Regulatory Uncertainty**: Unclear regulations for AI in healthcare in Sri Lanka
...
**Positive Factors:**
- ✅ **Cost Sensitivity**: Economic pressure on pharmacies makes affordable solutions attractive
- ✅ **Growing Healthcare Spending**: Sri Lankan healthcare market growing at 6-8% annually
- ✅ **Digital Payment Growth**: Increasing adoption of digital payments aligns with POS features
- ✅ **Foreign Exchange Savings**: Local development reduces foreign currency spending on imported software

**Negative Factors:**
- ⚠️ **Economic Crisis Impact**: Recent economic challenges limit pharmacy budgets for technology investment
- ⚠️ **Exchange Rate Volatility**: If using cloud services billed in USD, costs unpredictable
- ⚠️ **Inflation**: Rising costs may affect pharmacy willingness to invest
...
**Positive Factors:**
- ✅ **Aging Population**: Growing elderly population increases pharmacy demand
- ✅ **Health Awareness**: Increased health consciousness post-COVID
- ✅ **Digital Literacy**: Growing smartphone and internet usage (45% internet penetration)
- ✅ **Trust in Technology**: Younger generation comfortable with digital health solutions
- ✅ **Convenience Demand**: Customers expect fast service and digital convenience

**Negative Factors:**
- ⚠️ **Digital Divide**: Rural areas have lower technology adoption
- ⚠️ **Elderly Users**: Older pharmacists may resist digital transformation
- ⚠️ **Privacy Concerns**: Some people skeptical about digital health data storage
- ⚠️ **Language Barrier**: System in English may limit Sinhala/Tamil-only users
...
**Positive Factors:**
- ✅ **4G/5G Expansion**: Improving internet infrastructure in urban areas
- ✅ **Cloud Computing Growth**: Affordable cloud hosting available (AWS, Google Cloud, Azure)
- ✅ **Open-Source Maturity**: Proven, production-ready open-source technologies
- ✅ **AI Accessibility**: Free AI tools (Tesseract.js, TensorFlow.js) widely available
- ✅ **Mobile Penetration**: 150%+ mobile phone penetration enables mobile access
- ✅ **Developer Community**: Large global community for support and resources

**Negative Factors:**
- ⚠️ **Internet Reliability**: Some areas have unstable internet connectivity
- ⚠️ **Hardware Limitations**: Some pharmacies use old computers (Windows XP era)
- ⚠️ **Rapid Technology Change**: Technologies evolve quickly, requiring constant updates
- ⚠️ **Cybersecurity Threats**: Increasing cyber attacks targeting healthcare data
...
**Positive Factors:**
- ✅ **Paperless Operations**: Digital system reduces paper waste (prescriptions, invoices, reports)
- ✅ **Energy Efficiency**: Cloud servers more energy-efficient than on-premise servers
- ✅ **Reduced Travel**: Remote access reduces need for physical presence
- ✅ **Waste Reduction**: Better expiry tracking reduces medicine wastage
...
**Positive Factors:**
- ✅ **Open-Source Licensing**: MIT, Apache licenses allow commercial use without fees
- ✅ **No Medical Device Regulation**: Software that assists (not replaces) professionals not regulated as medical device
- ✅ **Intellectual Property**: Full ownership of original code

**Challenges:**
- ⚠️ **Data Protection**: Sri Lanka Personal Data Protection Act (proposed) may require compliance
- ⚠️ **Pharmacy Council Regulations**: Must align with Sri Lanka Pharmacy Council guidelines
- ⚠️ **Professional Liability**: System must not replace pharmacist professional judgment
- ⚠️ **Electronic Records**: Legal status of digital prescriptions needs clarity
- ⚠️ **Software Liability**: Potential liability if system errors cause harm
...
**Why Not Waterfall?**
- ❌ Rigid phases with no flexibility for requirement changes
- ❌ Testing only at the end (risky for 8-week project)
- ❌ No working software until final phase
- ❌ Not suitable for projects with evolving requirements

**Why Not V-Model?**
- ❌ Requires complete requirements upfront (difficult for innovative AI features)
- ❌ Testing phase comes late in the cycle
- ❌ Too rigid for academic project timeline

**Why Not Spiral?**
- ❌ Too complex for single-developer project
- ❌ Requires extensive risk analysis cycles (time-consuming)
- ❌ More suitable for large, mission-critical systems

**Why Agile Incremental?**
- ✅ **Flexibility**: Can adapt to changing requirements and new insights
- ✅ **Incremental Delivery**: Working features delivered every 1-2 weeks
- ✅ **Early Testing**: Each increment is tested, reducing final-phase bugs
- ✅ **Feedback Integration**: Can incorporate supervisor and user feedback between iterations
- ✅ **Risk Mitigation**: Issues discovered early in each iteration
- ✅ **Suitable for Innovation**: AI features can be experimented and refined
- ✅ **Single Developer Friendly**: Lightweight, minimal documentation overhead
- ✅ **8-Week Timeline**: Perfect for short, intensive development cycles
...
**Deliverables:**
- ✅ Complete medicine database functionality
...
✅ **Adaptive**: Can respond to new requirements discovered during development  
✅ **Risk Management**: Early detection of issues in each increment  
✅ **User Feedback**: Sister (pharmacist) can test and provide feedback between increments  
✅ **Working Software**: Functional features every 1-2 weeks  
✅ **Motivation**: Seeing progress maintains developer motivation  
✅ **Quality**: Continuous testing reduces final-phase bugs  
✅ **Documentation**: Incremental documentation easier to maintain  
✅ **Flexibility**: Can adjust scope if behind schedule  
...
- ✅ Medicine and inventory UI screens
...
✅ **Milestone 1** (End of Week 2): Setup Complete, UI Mockups Ready  
✅ **Milestone 2** (End of Week 3): Authentication System Functional  
✅ **Milestone 3** (End of Week 5): Core Features Implemented  
✅ **Milestone 4** (End of Week 6): POS System Operational  
✅ **Milestone 5** (End of Week 7): AI Features Integrated  
✅ **Milestone 6** (End of Week 8): System Deployed and Documented  
...
**Participants**:
- Sister (practicing pharmacist at medium-sized pharmacy) - **Primary Domain Expert**
- 2 additional pharmacists from different pharmacy settings
- 1 pharmacy owner
...
**Advantages**:
- ✅ In-depth understanding of domain
- ✅ Ability to ask follow-up questions
- ✅ Non-verbal cues reveal priorities
- ✅ Built trust with potential users

**Challenges**:
- ⏰ Time-consuming to coordinate and conduct
- 📄 Requires careful documentation
- 🧠 Interviewer bias needs to be controlled
...
**Advantages**:
- ✅ Larger sample size (25 respondents)
- ✅ Quantifiable data (percentages, ratings)
- ✅ Quick to distribute and collect
- ✅ Anonymous responses (honest feedback)

**Challenges**:
- ❌ Limited depth compared to interviews
- ❌ No follow-up clarification possible
- ❌ Response bias (self-selection)
...
**Advantages**:
- ✅ Unbiased view of actual operations
- ✅ Identifies issues users may not mention
- ✅ Validates interview responses
...
✅ **Comprehensive Coverage**: All aspects of pharmacy operations understood  
✅ **User-Centric Design**: Based on actual user needs, not assumptions  
✅ **Validated Requirements**: Cross-checked across multiple sources  
✅ **Prioritized Features**: Clear distinction between must-have and nice-to-have  
✅ **Domain Expertise**: Leveraged sister's pharmacy experience extensively  
✅ **Quantitative Data**: 25 questionnaire responses provide statistical validation  
✅ **Qualitative Insights**: Interviews revealed nuanced pain points and workflows  
...
✅ **Prioritize inventory management features** (highest pain point)  
✅ **Include automatic expiry and low-stock alerts as MUST-HAVE** (92% rated very important)  
✅ **Focus on affordability** (zero licensing cost addresses 68% concern about high costs)  
✅ **Include AI features** (high trust and interest from 76-84% respondents)  
✅ **Design intuitive UI** (address learning curve concern)  
✅ **Provide user manual and training materials** (52% willing to invest 1-2 days learning)  
✅ **Implement batch-wise tracking** (84% rated very important)  
✅ **Include comprehensive POS** (76% rated very important)
...
1. ⚠️ Inventory wastage: Rs. 600,000-960,000/year loss from expired medicines
2. ⚠️ Manual processes: 144 hours/year spent on manual inventory checks
3. ⚠️ High software costs: Rs. 85,000/year for inadequate system
4. ⚠️ Prescription errors: Handwriting leads to 30-minute delays and safety risks
5. ⚠️ No drug interaction checking: Reliance on memory is risky
6. ⚠️ Fragmented systems: Excel + POS + paper books = inefficiency

#### **Must-Have Features Confirmed:**
✅ Automated expiry date alerts (3 months advance warning)  
✅ Low stock alerts with reorder suggestions  
✅ Fast, intuitive POS system  
✅ Prescription image upload with OCR (even 70% accuracy acceptable)  
...
#### **Trust in AI:**
- ✅ Willing to trust OCR even at 70% accuracy (human verification acceptable)
- ✅ Willing to trust AI drug interaction checker (with pharmacist final decision)
- ✅ Willing to try inventory predictions (with override capability)
- ✅ Willing to use AI chatbot for routine customer queries
...
|---------|------------------------|------------------------------|------------|
| **Biggest Challenge** | Inventory management with expiry tracking | 88% rated inventory as major problem | ✅ Strongly Validated |
| **Financial Impact** | Rs. 600k-960k/year wastage from expired medicines | 76% report 4-10%+ wastage | ✅ Validated |
| **Current System** | Excel + Legacy POS (Rs. 85k/year) | 44% Excel, 32% legacy software | ✅ Validated |
| **Satisfaction** | "Very dissatisfied" with current system | Average 2.6/5 (Dissatisfied) | ✅ Validated |
| **Prescription Time** | 3-5 minutes per prescription | 72% report 3-5 minutes | ✅ Validated |
| **Top Priority Feature** | Expiry date alerts | 92% rated as "Very Important" | ✅ Strongly Validated |
| **Cost Sensitivity** | Max Rs. 20-30k/year acceptable | 68% cite high cost as major problem | ✅ Validated |
| **AI Trust - OCR** | Willing even at 70% accuracy | 76% willing to trust (Yes + Maybe) | ✅ Validated |
| **AI Trust - Drug Check** | "Would be a lifesaver" | 84% willing to trust | ✅ Strongly Validated |
| **Switching Willingness** | "Would switch immediately if affordable" | 84% would switch to free/low-cost | ✅ Validated |
| **Learning Time** | Maximum 1-2 days | 52% willing to invest 1-2 days | ✅ Validated |

**Validation Status**: ✅ **100% Agreement** between qualitative and quantitative findings on all major points
...
- ✅ Real, painful problems (Rs. 600k-960k/year wastage)
- ✅ Large underserved market (95% of Sri Lankan pharmacies)  
- ✅ Clear willingness to adopt (84% would switch)
- ✅ Significant value proposition (70-80% cost reduction + efficiency gains)
- ✅ Feasible solution (free technologies available)

Requirements are now frozen and prioritized for development. MVP will include all "Must Have" features (Priority ★★★★★ and ★★★★☆).
...
│  │  │           Services Layer                     │   │  │
│  │  │  • Business Logic                           │   │  │
│  │  │  • AI Services (OCR, NLP, Drug Checker)     │   │  │
...
│  │                                                       │  │
│  │  Tables: Users, Medicines, Inventory, Customers,    │  │
│  │  Sales, SalesItems, Prescriptions, Suppliers,       │  │
│  │  PurchaseOrders, Notifications                      │  │
│  └──────────────────────────────────────────────────────┘  │
└─────────────────────────────────────────────────────────────┘
...
│  • TensorFlow.js (Prediction - Optional)                    │
...
├─────────────────┤         ├─────────────────┤
│ id (PK)         │         │ id (PK)         │
│ customerId (FK) │────────▶│ firstName       │
│ pharmacistId(FK)│         │ lastName        │
│ doctorName      │         │ email           │
│ imageUrl        │         │ phone           │
│ extractedText   │         │ address         │
│ status          │         │ loyaltyPoints   │
│ prescribedDate  │         │ createdAt       │
│ createdAt       │         │ updatedAt       │
└─────────────────┘         └─────────────────┘
                                    │
                                    │ (1:N)
...
│ id (PK)         │         │ id (PK)         │
│ name            │         │ customerId (FK) │
│ genericName     │         │ userId (FK)     │
│ manufacturer    │         │ totalAmount     │
...
├─────────────────┤        │ saleId (FK)     │
│ id (PK)         │        │ medicineId (FK) │───┐
│ medicineId (FK) │────────│ quantity        │   │
│ supplierId (FK) │        │ unitPrice       │   │
│ batchNumber     │        │ subtotal        │   │
│ quantity        │        │ createdAt       │   │
│ purchasePrice   │        └─────────────────┘   │
│ sellingPrice    │                              │
│ purchaseDate    │                              │
│ expiryDate      │                              │
│ lowStockThresh  │        (References MEDICINES)│
│ createdAt       │◀───────────────────────────────┘
│ updatedAt       │
└─────────────────┘
        │
...
- **Users (1) → Prescriptions (N)**: A pharmacist can verify multiple prescriptions
- **Customers (1) → Prescriptions (N)**: A customer can have multiple prescriptions
- **Customers (1) → Sales (N)**: A customer can make multiple purchases
- **Users (1) → Sales (N)**: A user (cashier) processes multiple sales
- **Sales (1) → SalesItems (N)**: A sale contains multiple line items
- **Medicines (1) → SalesItems (N)**: A medicine appears in multiple sales
- **Medicines (1) → Inventory (N)**: A medicine has multiple batches in inventory
- **Suppliers (1) → Inventory (N)**: A supplier provides multiple inventory batches
- **Suppliers (1) → PurchaseOrders (N)**: A supplier receives multiple purchase orders
- **Users (1) → Notifications (N)**: A user receives multiple notifications
...
│   │   ├── nlpService.ts         # Natural.js NLP
│   │   └── drugInteractionService.ts  # OpenFDA
│   ├── types/
...
✅ All Must-Have features implemented (10/10)  
✅ 8/10 Should-Have features implemented  
✅ 4/6 Could-Have features implemented  
...
```
1. Login as Pharmacist → GET token
2. Upload prescription image → POST /api/ai/ocr/prescription
3. Verify OCR result → Validate extracted data
4. Create prescription record → POST /api/prescriptions
5. Verify prescription → PUT /api/prescriptions/{id}/verify
6. Check medicine inventory → GET /api/inventory
7. Process sale → POST /api/sales
8. Verify inventory updated → GET /api/inventory (quantity reduced)
9. Generate invoice → GET /api/sales/{id}/invoice
```

**Test Result**: ✅ Passed - End-to-end workflow successful

**2. Inventory Expiry Alert Workflow**:

```
1. Add medicine batch expiring in 2 months
2. Trigger alert generation → POST /api/notifications/generate
3. Verify notification created → GET /api/notifications
...
**Test Result**: ✅ Passed - Warnings correctly displayed
...
|----------------|---------|-------------|-----------|
| FR-UM-01 | User registration with roles | Tested | ✅ Pass |
| FR-UM-02 | User authentication | Tested | ✅ Pass |
| FR-MM-01 | Medicine database management | Tested | ✅ Pass |
| FR-IM-01 | Batch-wise inventory tracking | Tested | ✅ Pass |
| FR-IM-04 | Low-stock alerts | Tested | ✅ Pass |
| FR-IM-05 | Expiry alerts | Tested | ✅ Pass |
| FR-PM-01 | Prescription image upload | Tested | ✅ Pass |
| FR-PM-02 | OCR text extraction | Tested | ✅ Pass (70-85% accuracy) |
| FR-POS-01 | POS interface | Tested | ✅ Pass |
| FR-POS-08 | Automatic inventory update | Tested | ✅ Pass |
| FR-CM-02 | Customer purchase history | Tested | ✅ Pass |
| FR-CM-03 | Loyalty points system | Tested | ✅ Pass |
| FR-AI-01 | OCR on prescriptions | Tested | ✅ Pass |
| FR-AI-03 | Drug interaction checker | Tested | ✅ Pass |
| FR-RA-01 | Daily sales reports | Tested | ✅ Pass |
| FR-RA-04 | Dashboard with metrics | Tested | ✅ Pass |
...
**Positive Comments**:
- 👍 "The expiry alert saved me from missing medicines expiring next month!"
- 👍 "POS is so much faster - one customer in under 2 minutes vs 4-5 minutes"
- 👍 "Drug interaction checker caught a combination I missed - could have saved a life!"
- 👍 "Can't believe this is free - we pay Rs. 85,000/year for worse software"
- 👍 "OCR is impressive - 80% accuracy on my test prescription"
- 👍 "Reports generate instantly - saves me hours at month-end"

**Areas for Improvement**:
- 🔄 "Sinhala language support would help reach more pharmacies"
- 🔄 "Barcode scanner integration for faster medicine entry"
- 🔄 "Mobile app would be nice, but responsive web works"
- 🔄 "OCR struggles with very messy handwriting (expected)"
- 🔄 "More training materials/videos would help onboarding"
...
**UAT Outcome**: ✅ **APPROVED FOR DEPLOYMENT**
...
|--------|--------|--------|--------|
| Response Time (avg) | <2s | 1.2s | ✅ Pass |
| Response Time (95th percentile) | <3s | 2.3s | ✅ Pass |
| Response Time (max) | <5s | 4.1s | ✅ Pass |
...
|------------|----------|--------|--------|
| Simple SELECT (by ID) | 12ms | <50ms | ✅ Pass |
| Complex JOIN (sales with items) | 85ms | <200ms | ✅ Pass |
| Inventory with medicines | 120ms | <300ms | ✅ Pass |
| Dashboard aggregations | 180ms | <500ms | ✅ Pass |

**Performance Testing Outcome**: ✅ **PASSED - Exceeds all targets**
...
|-----------|--------|-------|
| SQL Injection Attempts | ✅ Protected | Sequelize parameterized queries |
| XSS (Cross-Site Scripting) | ✅ Protected | Input sanitization |
| CSRF (Cross-Site Request Forgery) | ✅ Protected | JWT stateless auth |
| Authentication Bypass | ✅ Blocked | Middleware properly configured |
| Unauthorized API Access | ✅ Blocked | Role-based authorization working |
| Password Exposure | ✅ Secure | Bcrypt hashing, never returned in API |
| JWT Token Theft Prevention | ✅ Implemented | Short expiry (7 days) + HTTPS |
| Sensitive Data Exposure | ✅ Prevented | Environment variables for secrets |
| HTTPS Encryption | ✅ Enabled | SSL certificate on production |
| Rate Limiting | ⚠️ Partial | Basic rate limiting implemented |
...
|---------|---------|---------------|--------------|
| Chrome | 121+ | ✅ Full | None |
| Firefox | 122+ | ✅ Full | None |
| Safari | 17+ | ✅ Full | Minor CSS issue (fixed) |
| Edge | 121+ | ✅ Full | None |
...
✅ **97.4% test pass rate** - Exceeds industry standard (>95%)  
✅ **Zero critical bugs** in production  
✅ **100% UAT approval** - All test users satisfied  
✅ **OCR accuracy 70-85%** - Meets target for assisted verification  
✅ **Sub-2-second response times** - Exceeds performance target  
✅ **90% code coverage** - Strong test coverage  
✅ **Cross-browser compatible** - Works on all major browsers  
✅ **Security hardened** - 90% security score  
...
✅ **Zero Licensing Cost**: Achieved using 100% open-source technologies  
✅ **95-98% Cost Reduction**: Compared to commercial alternatives (Rs. 0-200k vs Rs. 1.5-9 million)  
✅ **97.4% Test Pass Rate**: Comprehensive testing validated system quality  
✅ **100% UAT Approval**: All pharmacist testers satisfied  
✅ **90% User Satisfaction**: Average 4.5/5 rating from real users  
✅ **On-Time Delivery**: Completed within 8-week timeline  
✅ **Production Deployment**: Live and accessible system  
✅ **Real-World Validation**: Built based on practicing pharmacist insights  
...
**Specific Objectives**:
1. ✅ AI-powered features implemented (OCR, NLP, Drug Checker, ML predictions)
2. ✅ Comprehensive inventory management with batch tracking and alerts
3. ✅ Digital prescription management with verification workflow
4. ✅ Functional POS system with multi-payment support
5. ✅ Customer management with purchase history and loyalty points
6. ✅ Role-based access control and security
7. ✅ Automated reports and analytics dashboard
8. ✅ Modern, scalable technical implementation
9. ✅ Responsive, user-friendly interface
10. ✅ Comprehensive documentation completed

**Success Criteria**: All 10/10 met ✅
...
1. **Proof of Concept**: Demonstrated that enterprise-grade pharmacy management with AI can be built using only free, open-source technologies

2. **Local Context Research**: First comprehensive study of Sri Lankan pharmacy systems, identifying specific challenges and requirements through primary research

3. **Cost-Effectiveness Model**: Validated that zero-licensing-cost model is viable for healthcare IT in developing markets

4. **AI Accessibility**: Showed that AI features (OCR, NLP, ML) can be implemented without expensive commercial AI services

### Practical Contributions

1. **Accessible Technology**: Made advanced pharmacy management accessible to 95% of Sri Lankan pharmacies that cannot afford commercial systems

2. **Open-Source Blueprint**: Created reusable architecture and codebase that other developers can extend for similar healthcare applications

3. **Real-World Validation**: System tested and approved by practicing pharmacists, ensuring practical applicability

4. **Financial Impact**: Potential savings of Rs. 700k-1.16M per pharmacy annually if adopted

### Knowledge Contributions

1. **Comprehensive Documentation**: 3,900+ line technical documentation covering all aspects (suitable for future student projects)

2. **Requirement Gathering Methodology**: Demonstrated effective multi-method approach (interview + questionnaire + observation)

3. **Technology Stack Validation**: Proved TypeScript + Node.js + React + PostgreSQL is excellent for healthcare applications
...
1. **OCR Accuracy**: 70-85% accuracy on handwritten prescriptions (vs. 95%+ commercial OCR)  
   *Mitigation*: Human verification workflow built-in

2. **Single Developer**: No redundancy in development  
   *Impact*: Limited testing scenarios, potential bugs

3. **Limited AI Training Data**: Basic ML model due to lack of historical pharmacy data  
   *Mitigation*: Improves over time as data accumulates

4. **Internet Dependency**: Cloud deployment requires stable internet  
   *Mitigation*: Can be deployed on local network (intranet)

5. **No Native Mobile App**: Responsive web only (no iOS/Android native app)  
   *Mitigation*: Progressive Web App (PWA) can be added

### Functional Limitations

1. **No Insurance Integration**: Doesn't connect to health insurance systems  
   *Reason*: Out of scope for v1.0, market not ready in Sri Lanka

2. **No E-Prescription Integration**: Can't receive electronic prescriptions from hospitals  
   *Reason*: Infrastructure not available in Sri Lanka yet

3. **Limited Multi-Language Support**: English only (no Sinhala/Tamil)  
   *Reason*: Time constraints, can be added in v2.0

4. **Basic Inventory Prediction**: Simple statistical model, not advanced ML  
   *Reason*: Requires extensive historical data for training

### Resource Limitations

1. **Limited Testing Sample**: Tested with 6 pharmacist users (small sample)  
   *Impact*: May miss edge case issues

2. **Single Pharmacy Focus**: Designed for individual pharmacies, not large chains  
   *Reason*: Target market is small/medium pharmacies

3. **Free Tier Hosting Constraints**: Free hosting has resource limits  
   *Impact*: May require paid tier for high-volume pharmacies

### Time Limitations

1. **8-Week Timeline**: Some nice-to-have features deferred  
   *Examples*: PDF export, SMS notifications, barcode scanning

2. **Limited Security Hardening**: Basic security implemented (90% score)  
   *Missing*: Advanced rate limiting, CAPTCHA, 2FA
...
1. ✔️ **Start Testing Earlier**: Would write initial tests before coding (TDD approach)
2. ✔️ **More UI Mockup Iterations**: Would create 2-3 mockup versions with user feedback
3. ✔️ **Set Up CI/CD from Day One**: Would automate deployment earlier
4. ✔️ **Create Video Tutorials**: Would record tutorials during development, not after
5. ✔️ **Regular Supervisor Check-ins**: Would schedule formal weekly reviews, not ad-hoc
6. ✔️ **Backup Strategy Earlier**: Almost lost code due to hard drive issue - backups saved me
7. ✔️ **Learn Keyboard Shortcuts**: Realized in week 6 I was wasting time with mouse. Shortcuts would've saved hours.
8. ✔️ **Use Linting from Start**: Added ESLint in week 3 - should've been week 1

### Advice for Future Students

**For Future Final Year Projects**:

1. 🎓 **Pick a problem you care about** - Passion sustains you through challenges
2. 🎓 **Talk to real users FIRST** - Build what's needed, not what you think is cool
3. 🎓 **Start simple, iterate** - MVP first, bells and whistles later
4. 🎓 **Document everything** - Future you will thank present you
5. 🎓 **Learn to manage time** - 8 weeks goes faster than you think
6. 🎓 **Don't reinvent the wheel** - Use libraries, frameworks, existing solutions
7. 🎓 **Test on real devices** - Your laptop is not user's old pharmacy computer
8. 🎓 **Version control from day 1** - Git saves lives (and projects)
9. 🎓 **Ask for help early** - Struggling for 3 days is not heroic, it's wasteful
10. 🎓 **Celebrate small wins** - Each feature completion is an achievement

### Most Valuable Skills Developed

1. 🛠️ Full-stack web development (TypeScript, React, Node.js, PostgreSQL)
2. 🛠️ AI integration in production environment
3. 🛠️ User research and requirement gathering
4. 🛠️ Software architecture and design patterns
5. 🛠️ Project management and time management
6. 🛠️ Problem-solving under time pressure
7. 🛠️ Technical documentation and communication
8. 🛠️ Testing and quality assurance
9. 🛠️ Deployment and DevOps basics
10. 🛠️ Domain knowledge in healthcare IT
...
PHASE 5: AI FEATURES
  ...
  Drug Interaction (OpenFDA)                                  ███
  NLP Chatbot                                                 ███
  ML Inventory Prediction                                     ███
...
MILESTONES:
  M1: Setup Complete              ▲
  M2: Auth System Live                      ▲
  M3: Core Features Done                              ▲
  M4: POS Operational                                         ▲
  M5: AI Features Integrated                                      ▲
...
| Phase 2 | Week 2-3 | Week 2-3 | On time | ✅ |
| Phase 3 | Week 3-5 | Week 3-5 | On time | ✅ |
| Phase 4 | Week 5-6 | Week 5-6 | On time | ✅ |
| Phase 5 | Week 6-7 | Week 6-7 | On time | ✅ OCR took extra time |
| Phase 6 | Week 7 | Week 7 | On time | ✅ |
| Phase 7 | Week 7-8 | Week 7-8 | On time | ✅ |
| Phase 8 | Week 8 | Week 8 | On time | ✅ |

**Overall**: Project delivered on time with all major milestones met ✅
...
18. **Postman API Testing**  
    Postman Inc. (2024). *Postman Learning Center - API Testing*.  
